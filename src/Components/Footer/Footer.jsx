...
const Footer = () => {
  ...
  return (
    <div className="mt-16 pt-10 bg-[#140C1C]">
      <Typography
        as="a"
        href="#"
        className="mr-4 cursor-pointer py-1.5 font-bold w-full text-center flex flex-row items-center justify-center  gap-2 font-poppins text-2xl text-white"
      >
      ...
      <p className="text-center font-roboto font-medium text-lg text-gray-400"> Let&apos;s connect and overcome challenges together.</p>
      <div className="flex w-full flex-col items-center justify-center container mx-auto  mt-16 bg-[#140C1C] py-4 md:flex-row md:justify-between">
        ...
        <Typography
          variant="small"
          className="mb-4 text-center font-normal text-[#9463F7] md:mb-0"
        >
          &copy; {currentYear} <a href="https://material-tailwind.com/">|Samya Roy</a>. All
          Rights Reserved.
        </Typography>
      </div>
    </div>
