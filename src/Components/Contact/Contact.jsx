                    ...
                    <div className="mt-12">
                        ...
                        <ul className="mt-4">
                            <li className="flex items-center">
                                <div className="bg-transparent  hover:shadow-lg shadow-md shadow-[#9463F7]  border-2 border-[#9463F7] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                ...
                                <a href="javascript:void(0)" className="text-[#9463F7] text-sm ml-4">
