...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_blun0hh', 'template_h6mal1g', form.current, {
                publicKey: 'xK5200yTuty8ZP1jT',
            })
            .then(
                () => {
                    console.log('SUCCESS!');
    ...
    return (
        ...
        <div className="w-full text-center mb-16">
            ...
            <div className="grid sm:grid-cols-2 items-start border  border-white gap-16 p-4 lg:p-10 mx-auto max-w-4xl  font-[sans-serif] bg-gradient-to-br  from-[#211138] to-[#0F0715]">
                <div>
                ...
                <form ref={form} onSubmit={sendEmail} className="ml-auto space-y-4">
                    <div className="flex gap-3">
                        <input type='text' placeholder='Name' name="from_name"
                            className="w-full rounded-md py-3 px-4 bg-transparent border-2 border-[#9463F7] text-white text-sm outline-blue-500 focus:bg-transparent" />
